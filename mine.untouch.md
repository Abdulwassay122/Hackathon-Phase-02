now i want to add phase 3 in this as usual divide in to 2 specs and write 1 overall contitution for phase 3 and specify for each spec (write short prompts)
